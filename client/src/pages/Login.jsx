      ...
      <div className="z-20 w-full max-w-md bg-gray-900 border border-gray-700 rounded-xl shadow-lg p-8 sm:p-10 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full text-white bg-gradient-to-r from-blue-400 to-blue-700 hover:from-blue-600 hover:to-blue-800  font-semibold transition glow-button disabled:opacity-50 px-4 py-2 duration-500 rounded-md"
          >
